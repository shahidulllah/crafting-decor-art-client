            ...
            <div className="carousel w-full rounded-b-xl h-[40vh] lg:h-[95vh]">
                <div id="slide1" className="carousel-item relative w-full  ">
                    ...
                    <div className="bg-black/5 absolute w-full h-full flex flex-col justify-center items-center text-white P-8 space-y-5">
                        <h1 className="text-3xl lg:text-6xl font-serif font-bold text-center animate__animated animate__rubberBand animate__slow">Collect Your Best Choice View</h1>
                        <h1 className="lg:text-3xl text-center animate__animated animate__fadeInUp animate__slow p-6 rounded bg-yellow-500">Art & Craft spearing now</h1>
                    </div>
