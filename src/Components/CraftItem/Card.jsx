    ...
    return (
        <div className="max-w-sm rounded-2xl shadow-2xl dark:bg-gray-50 dark:text-gray-800 border-2 ">
            ...
            <div className="flex flex-col justify-between p-6 space-y-8">
               ...
               <Link to={`/viewDetails/${item._id}`}> <button type="button" className="flex btn btn-success items-center justify-center w-full p-3 font-extrabold tracking-wide rounded-md dark:bg-violet-600 dark:text-gray-50 ">View Details</button></Link>
            </div>
        </div>
    );
