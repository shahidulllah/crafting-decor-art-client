    ...
    return (
        <div className="bg-purple-200">
            <div className="overflow-x-auto p-4 lg:mx-24 py-20">
               <div className="flex flex-col items-center justify-center border-b-2 pb-10">
               <h1 className="text-4xl lg:text-5xl font-bold text-center"><u>All Items Is Here</u></h1>
               </div>
                <table className="table bg-purple-300">
                    {/* head */}
                    <thead className="text-sm shadow-lg bg-gray-200">
                        <tr className="text-center">
                            <th>Category Name/ <span className="opacity-60 badge badge-sm">Sub-Category</span></th>
                            <th>Price</th>
                            <th>Rating</th>
                            <th>Stock Status</th>
                            <th>Details</th>
